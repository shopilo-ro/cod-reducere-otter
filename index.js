#!/usr/bin/env node
/**
 * Fetch coduri reducere Otter de pe shopilo.ro
 * Homepage: https://shopilo.ro/magazin/otter.ro
 */

const SHOPILO_URL = "https://shopilo.ro/magazin/otter.ro";
const STORE_NAME  = "Otter";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-ro/cod-reducere-otter)" }
  });
